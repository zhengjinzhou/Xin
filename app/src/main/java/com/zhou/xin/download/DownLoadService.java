...
public class DownLoadService extends Service {
     ...
     * 目标文件存储的文件名
     */
    private String destFileName = "恋爱.apk";
    ...
    private void loadFile() {
        ...
        retrofit.baseUrl("http://123.207.55.87:8080/LoveMe/")
    ...
    public interface IFileLoad {
        @GET("apk/file/201803/272123125i4b.apk")
    ...
    private void installApk(File file) {
        if(Build.VERSION.SDK_INT>=24) {//判读版本是否在7.0以上
            Uri apkUri = FileProvider.getUriForFile(this, "com.zhou.xin.fileprovider", file);
