...
import com.zhou.xin.base.DemoModel;
...
//            broadcastManager = LocalBroadcastManager.getInstance(appContext);
    ...
    private EaseUser getUserInfo(String username){
        ...
        if(username.equals(EMClient.getInstance().getCurrentUser())){
            ...
            user.setAvatar((String) SharedPreferencesUtils.getParam(appContext, Constant.USER_HEAD_IMG,""));
            user.setNick((String)SharedPreferencesUtils.getParam(appContext, Constant.USER_NAME,"nike"));
            return user;
        }
