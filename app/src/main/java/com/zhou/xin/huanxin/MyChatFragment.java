...
import com.zhou.xin.domain.EmojiconExampleGroupData;
import com.zhou.xin.domain.RobotUser;
import com.zhou.xin.ui.activity.huanxin.ChatRoomDetailsActivity;
import com.zhou.xin.ui.activity.huanxin.ContextMenuActivity;
import com.zhou.xin.ui.activity.huanxin.ForwardMessageActivity;
import com.zhou.xin.ui.activity.huanxin.GroupDetailsActivity;
import com.zhou.xin.ui.activity.huanxin.ImageGridActivity;
import com.zhou.xin.ui.activity.huanxin.MainActivity;
import com.zhou.xin.ui.activity.huanxin.PickAtUserActivity;
...
public class MyChatFragment extends EaseChatFragment implements EaseChatFragment.EaseChatFragmentHelper {
    ...
    public void onSetMessageAttributes(EMMessage message) {
        ...
        //设置要发送扩展消息用户昵称
        message.setAttribute(Constant.USER_NAME, (String) SharedPreferencesUtils.getParam(getActivity().getApplicationContext(), Constant.USER_NAME,"nike"));
        message.setAttribute(Constant.USER_ID, (String) SharedPreferencesUtils.getParam(getActivity().getApplicationContext(), Constant.USER_NAME,"nike"));
        //设置要发送扩展消息用户头像
        message.setAttribute(Constant.HEAD_IMAGE_URL, (String)SharedPreferencesUtils.getParam(getActivity().getApplicationContext(),Constant.USER_HEAD_IMG,""));
        message.setAttribute(Constant.SEX,"1");
        message.setAttribute(Constant.RECEIVOR_HEAD_IMAGE_URL,"http://img0.imgtn.bdimg.com/it/u=3707678312,2260123328&fm=27&gp=0.jpg");
